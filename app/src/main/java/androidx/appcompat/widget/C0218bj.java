...
public final class C0218bj {

    /* renamed from: d */
    private static Class<?> f1200d;

    /* renamed from: b */
    private static final int[] f1198b = {R.attr.state_checked};

    /* renamed from: c */
    private static final int[] f1199c = new int[0];

    /* renamed from: a */
    public static final Rect f1197a = new Rect();

    static {
        if (Build.VERSION.SDK_INT >= 18) {
            try {
                f1200d = Class.forName("android.graphics.Insets");
    ...
    */
    public static android.graphics.Rect m847a(android.graphics.drawable.Drawable r10) {
        /*
            ...
            return r0
        L20:
            java.lang.Class<?> r0 = androidx.appcompat.widget.C0218bj.f1200d
            if (r0 == 0) goto Lbf
            android.graphics.drawable.Drawable r10 = androidx.core.graphics.drawable.C0546a.m1934g(r10)     // Catch: java.lang.Exception -> Lb8
            ...
            java.lang.Class<?> r1 = androidx.appcompat.widget.C0218bj.f1200d     // Catch: java.lang.Exception -> Lb8
        ...
        Lbf:
            android.graphics.Rect r10 = androidx.appcompat.widget.C0218bj.f1197a
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.C0218bj.m847a(android.graphics.drawable.Drawable):android.graphics.Rect");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: b */
    public static void m848b(Drawable drawable) {
        if (Build.VERSION.SDK_INT == 21 && "android.graphics.drawable.VectorDrawable".equals(drawable.getClass().getName())) {
            int[] state = drawable.getState();
            if (state == null || state.length == 0) {
                drawable.setState(f1198b);
            } else {
                drawable.setState(f1199c);
            }
    ...
    /* renamed from: c */
    public static boolean m849c(Drawable drawable) {
        while (true) {
            ...
            } else if (drawable instanceof C0123l) {
                drawable = ((C0123l) drawable).m299a();
            } else {
    ...
    /* renamed from: a */
    public static PorterDuff.Mode m846a(int i, PorterDuff.Mode mode) {
        if (i == 3) {
