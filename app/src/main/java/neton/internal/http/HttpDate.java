...
public final class HttpDate {
    ...
    private static final ThreadLocal<DateFormat> STANDARD_DATE_FORMAT = new ThreadLocal<DateFormat>() { // from class: neton.internal.http.HttpDate.1
        C25111() {
        }
    ...
    /* renamed from: neton.internal.http.HttpDate$1 */
    /* loaded from: classes.dex */
    final class C25111 extends ThreadLocal<DateFormat> {
        C25111() {
        }
