...
public final class CallServerInterceptor implements Interceptor {
    ...
    public final Response intercept(Interceptor.Chain chain) {
        ...
        try {
            ...
            realInterceptorChain.eventListener().requestHeadersEnd(realInterceptorChain.call(), null);
            if (!HttpMethod.permitsRequestBody(request.method()) || request.body() == null) {
                ...
                try {
                    ...
                    realInterceptorChain.eventListener().requestBodyEnd(realInterceptorChain.call(), null);
                } catch (IOException e) {
            ...
            if (builder == null) {
                ...
                try {
                    ...
                    realInterceptorChain.eventListener().responseHeadersEnd(realInterceptorChain.call(), null);
