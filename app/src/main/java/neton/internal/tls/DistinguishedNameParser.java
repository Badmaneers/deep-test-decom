...
final class DistinguishedNameParser {
    ...
    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f10851dn = x500Principal.getName("RFC2253");
        this.length = this.f10851dn.length();
    }
    ...
    private String nextAT() {
        ...
        if (this.pos >= this.length) {
            throw new NetonException(new IllegalStateException("Unexpected end of DN: " + this.f10851dn));
        }
        this.end = this.pos;
    ...
    private int getByte(int i) {
        ...
        int i4 = i + 1;
        if (i4 >= this.length) {
            throw new NetonException(new IllegalStateException("Malformed DN: " + this.f10851dn));
        }
        char c = this.chars[i];
        if (c >= '0' && c <= '9') {
            i2 = c - '0';
    ...
    public final String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f10851dn.toCharArray();
