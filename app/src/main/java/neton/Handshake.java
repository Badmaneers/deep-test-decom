...
public final class Handshake {
    ...
    public static Handshake get(SSLSession sSLSession) {
        ...
        if (cipherSuite == null) {
            throw new NetonException(new IllegalStateException("cipherSuite == null"));
        }
        CipherSuite forJavaName = CipherSuite.forJavaName(cipherSuite);
        String protocol = sSLSession.getProtocol();
        if (protocol == null) {
            throw new NetonException(new IllegalStateException("tlsVersion == null"));
        }
    ...
    public static Handshake get(TlsVersion tlsVersion, CipherSuite cipherSuite, List<Certificate> list, List<Certificate> list2) {
        if (tlsVersion == null) {
            throw new NetonException(new NullPointerException("tlsVersion == null"));
        }
        if (cipherSuite == null) {
            throw new NetonException(new NullPointerException("cipherSuite == null"));
        }
