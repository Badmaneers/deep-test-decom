...
public final class ConnectionSpec {
    ...
    public final class Builder {
        ...
        public final Builder allEnabledCipherSuites() {
            if (!this.tls) {
                throw new NetonException(new IllegalStateException("no cipher suites for cleartext connections"));
            }
        ...
        public final Builder cipherSuites(String... strArr) {
            ...
            if (strArr.length == 0) {
                throw new NetonException(new IllegalArgumentException("At least one cipher suite is required"));
            }
        ...
        public final Builder allEnabledTlsVersions() {
            if (!this.tls) {
                throw new NetonException(new IllegalStateException("no TLS versions for cleartext connections"));
            }
        ...
        public final Builder tlsVersions(String... strArr) {
            ...
            if (strArr.length == 0) {
                throw new NetonException(new IllegalArgumentException("At least one TLS version is required"));
            }
        ...
        public final Builder supportsTlsExtensions(boolean z) {
            if (!this.tls) {
                throw new NetonException(new IllegalStateException("no TLS extensions for cleartext connections"));
            }
