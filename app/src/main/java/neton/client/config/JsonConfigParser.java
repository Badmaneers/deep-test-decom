...
public class JsonConfigParser implements Parser {
    @Override // neton.client.config.Parser
    public void parse(String str) {
        try {
            ...
            LogUtil.m7844d("JsonConfigParser--parse-JSONException:" + e.getMessage());
        } catch (Exception e2) {
            LogUtil.m7844d("JsonConfigParser--parse-Exception:" + e2.getMessage());
        }
    }
}
