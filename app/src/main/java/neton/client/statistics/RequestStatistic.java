...
public class RequestStatistic {
    ...
    public String toString() {
        return "traceID:" + this.traceID + ",url:" + this.url + ",ip:" + this.f10848ip + ",serviceMethod:" + this.serviceMethod + ",startTime:" + this.startTime + ",dnsStartTime:" + this.dnsStartTime + ",dnsEndTime:" + this.dnsEndTime + ",networkRequestStartTime:" + this.networkRequestStartTime + ",startSslTime:" + this.startSslTime + ",endSslTime:" + this.endSslTime + ",endTime:" + this.endTime + ",responseCode:" + this.responseCode + ",responseMessage:" + this.responseMessage + ",networkType:" + this.networkType;
    }
}
