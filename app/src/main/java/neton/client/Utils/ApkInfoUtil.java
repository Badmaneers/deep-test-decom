...
public class ApkInfoUtil {
    ...
    public static String getRegionCode() {
        ...
        LogUtil.m7844d("getRegionCode:".concat(String.valueOf(str)));
        return str;
    }
    ...
    public static int getVersionCode(Context context) {
        try {
            ...
            LogUtil.m7847e("getVersionCode--Exception");
            return 0;
        }
    }
    ...
    public static String getPackageName(Context context) {
        try {
            ...
            LogUtil.m7847e("getPackageName:" + e.toString());
            return SSOID_DEFAULT;
        }
    }
    ...
    public static String getSsoID(Context context) {
        ...
        if (str.equals(SSOID_DEFAULT)) {
            LogUtil.m7847e("getSsoID not set.");
        }
        return str;
    }
    ...
    public static boolean isExistPackage(Context context, String str) {
        try {
            ...
            LogUtil.m7847e("isExistPackage NameNotFoundException");
            return false;
        }
    }
}
