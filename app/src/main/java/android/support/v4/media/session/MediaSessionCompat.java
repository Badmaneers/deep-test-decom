...
import androidx.media.AbstractC0765ai;
import androidx.media.AbstractC0767ak;
import androidx.media.C0758ab;
...
public class MediaSessionCompat {
    ...
    public interface MediaSessionImpl {
        ...
        C0758ab getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(C0758ab c0758ab);
        ...
        void setPlaybackToRemote(AbstractC0765ai abstractC0765ai);
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (componentName == null && (componentName = MediaButtonReceiver.m2680a(context)) == null) {
    ...
    /* loaded from: classes.dex */
    public class C00231 extends Callback {
        C00231() {
        }
    }
    ...
    /* loaded from: classes.dex */
    public class C00242 extends Callback {
        C00242() {
        }
    }
    ...
    /* loaded from: classes.dex */
    public class C00253 extends Callback {
        C00253() {
        }
    }
    ...
    public void setPlaybackToRemote(AbstractC0765ai abstractC0765ai) {
        if (abstractC0765ai == null) {
            throw new IllegalArgumentException("volumeProvider may not be null!");
        }
        this.mImpl.setPlaybackToRemote(abstractC0765ai);
    }
    ...
    public final C0758ab getCurrentControllerInfo() {
    ...
    public abstract class Callback {
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            C0758ab currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
        ...
        void handleMediaPlayPauseKeySingleTapIfPending(C0758ab c0758ab) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(c0758ab);
                if (z && z3) {
                    onPause();
                } else if (!z && z2) {
                    onPlay();
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((C0758ab) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            C0410h.m1465a(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
    ...
    public final class Token implements Parcelable {
        ...
        public final Bundle toBundle() {
            ...
            if (this.mExtraBinder != null) {
                C0410h.m1465a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, this.mExtraBinder.asBinder());
            }
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(C0410h.m1464a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        /* loaded from: classes.dex */
        final class C00311 implements Parcelable.Creator<Token> {
            C00311() {
            }
    ...
    public final class QueueItem implements Parcelable {
        ...
        /* loaded from: classes.dex */
        final class C00291 implements Parcelable.Creator<QueueItem> {
            C00291() {
            }
    ...
    public final class ResultReceiverWrapper implements Parcelable {
        ...
        /* loaded from: classes.dex */
        final class C00301 implements Parcelable.Creator<ResultReceiverWrapper> {
            C00301() {
            }
    ...
    public class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private C0758ab mRemoteUserInfo;
        int mRepeatMode;
        ...
        AbstractC0765ai mVolumeProvider;
        int mVolumeType;
        ...
        private AbstractC0767ak mVolumeCallback = new AbstractC0767ak() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            C00281() {
            }

            @Override // androidx.media.AbstractC0767ak
            public void onVolumeChanged(AbstractC0765ai abstractC0765ai) {
                if (MediaSessionImplBase.this.mVolumeProvider != abstractC0765ai) {
                    return;
                }
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(MediaSessionImplBase.this.mVolumeType, MediaSessionImplBase.this.mLocalStream, abstractC0765ai.m2667b(), abstractC0765ai.m2668c(), abstractC0765ai.m2665a()));
            }
        };
        ...
        /* loaded from: classes.dex */
        public class C00281 extends AbstractC0767ak {
            C00281() {
            }
        ...
        public void setPlaybackToLocal(int i) {
            if (this.mVolumeProvider != null) {
                this.mVolumeProvider.m2666a(null);
            }
            this.mLocalStream = i;
            this.mVolumeType = 1;
        ...
        public void setPlaybackToRemote(AbstractC0765ai abstractC0765ai) {
            ...
            this.mVolumeType = 2;
            this.mVolumeProvider = abstractC0765ai;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.m2667b(), this.mVolumeProvider.m2668c(), this.mVolumeProvider.m2665a()));
            abstractC0765ai.m2666a(this.mVolumeCallback);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public C0758ab getCurrentControllerInfo() {
            C0758ab c0758ab;
            synchronized (this.mLock) {
                c0758ab = this.mRemoteUserInfo;
            }
            return c0758ab;
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(C0758ab c0758ab) {
            synchronized (this.mLock) {
                this.mRemoteUserInfo = c0758ab;
            }
        }
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new C0758ab("android.media.session.MediaController", getCallingPid(), getCallingUid()));
                }
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    AbstractC0765ai abstractC0765ai = MediaSessionImplBase.this.mVolumeProvider;
                    if (i == 2) {
                        int m2667b = abstractC0765ai.m2667b();
                        int m2668c = abstractC0765ai.m2668c();
                        i4 = m2667b;
                        streamVolume = abstractC0765ai.m2665a();
                        i3 = m2668c;
                    } else {
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new C0758ab(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
    ...
    public class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        /* loaded from: classes.dex */
        public class C00261 implements RemoteControlClient.OnPlaybackPositionUpdateListener {
            C00261() {
            }
    ...
    public class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        /* loaded from: classes.dex */
        class C00271 implements RemoteControlClient.OnMetadataUpdateListener {
            C00271() {
            }
    ...
    public class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(AbstractC0765ai abstractC0765ai) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, abstractC0765ai.m2669d());
        }
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new C0758ab(callingPackage, getCallingPid(), getCallingUid()));
            }
    ...
    public class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final C0758ab getCurrentControllerInfo() {
            return new C0758ab(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }
    }
}
